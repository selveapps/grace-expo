...
Source of truth for copy: `docs/legal/PRIVACY.md` and `docs/legal/TERMS.md`.

## Target URLs (App Store)

`src/legal.js` points at:

- `https://selveapps.xyz/grace/privacy`
- `https://selveapps.xyz/grace/terms`

Both must return **200** before App Store submission.
