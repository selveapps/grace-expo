...
const styles = StyleSheet.create({
  ...
  sub: { fontFamily: fonts.sans, fontSize: 16, lineHeight: 24, color: colors.textMuted, marginTop: 8, marginBottom: 22 },
  ...
  carriedLabel: { fontFamily: fonts.sans, fontSize: 13, color: colors.textMuted },
  carriedList: { flex: 1, fontFamily: fonts.serifItalic, fontSize: 18, color: colors.brass, textAlign: 'right' },
  hint: { fontFamily: fonts.sans, fontSize: 16, lineHeight: 24, color: colors.danger, marginBottom: 14, textAlign: 'center' },
});
