...
import { View, Text, StyleSheet, ScrollView, PanResponder, Animated, Easing } from 'react-native';
...
export default function SliderScreen({ navigation }) {
  ...
  return (
    <Screen gradient={s.grad} style={styles.fill} ambient>
...
const styles = StyleSheet.create({
  ...
  mid: { justifyContent: 'center', marginVertical: 20 },
