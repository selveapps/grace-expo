...
const styles = StyleSheet.create({
  ...
  subhead: { fontFamily: fonts.sans, fontSize: 16, lineHeight: 24, color: colors.textMuted, textAlign: 'center', marginTop: 8, marginBottom: 26 },
  list: { gap: 12 },
  ...
  cardTitle: { fontFamily: fonts.serifSemi, fontSize: 22, color: colors.ink },
  cardSub: { fontFamily: fonts.sans, fontSize: 15, lineHeight: 22, color: colors.textMuted, marginTop: 2 },
});
